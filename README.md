Bu proje, React kullanarak basit bir task (görev) yönetim uygulamasıdır. Uygulama, kullanıcılara yeni görevler oluşturma, mevcut görevleri düzenleme ve silme imkanı sunar.
